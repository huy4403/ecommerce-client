...
function Header() {
    ...
    const UserMenu = () => (
        <div className="absolute right-0 top-12 w-48 bg-white rounded-lg shadow-lg py-2 z-50 text-center">
    ...
    const CategoryMenu = () => (
        <div className="relative">
            <button
                className="text-pink-500 font-medium text-lg uppercase flex items-center"
                        ...
                        <div key={category.id} className="mb-2">
                            <Link
                                to={category.childrenCategories && category.childrenCategories.length > 0
                                    ? "#"
                                    : `/products`}
                                className={`flex items-center justify-between px-4 py-2 hover:bg-pink-50 rounded-md w-full ${thisPath.pathname === '/products' && context.categorySelected === category.name
                                ...
                                <div className="ml-4 mt-1">
                                    {category.childrenCategories.map((subCategory) => (
                                        <Link
                                            key={subCategory.id}
                                            to={`/products`}
                                            className={`flex items-center px-4 py-2 hover:bg-pink-50 rounded-md w-full ${thisPath.pathname === '/products' && context.categorySelected === subCategory.name
                                                ? "bg-pink-200 text-pink-700 font-semibold"
                                                : "text-gray-600"
                                                }`}
                                            onClick={() => {
    ...
    return (
        <>
                ...
                <div className="container mx-auto px-4 py-4">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-4">
                            ...
                            <Link to="/products" className="text-pink-500 font-medium text-lg uppercase">Sản phẩm</Link>
                            <CategoryMenu />
                        </div>
            ...
            {/* Menu mobile */}
            {isMenuOpen && (
                <div className="md:hidden bg-white shadow-lg p-4 flex justify-center text-center border-2 border-pink-300 w-full">
